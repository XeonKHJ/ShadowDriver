...
extern const MIDL_SERVER_INFO ShadowDriverRPC_ServerInfo;

extern const RPC_DISPATCH_TABLE ShadowDriverRPC_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE ShadowDriverRPC___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x3f299c8f,0x35db,0x46b2,{0x9d,0xef,0x6a,0x49,0xe3,0x39,0xf6,0xff}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&ShadowDriverRPC_v1_0_DispatchTable,
    0,
    0,
    0,
    &ShadowDriverRPC_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE ShadowDriverRPC_v1_0_s_ifspec = (RPC_IF_HANDLE)& ShadowDriverRPC___RpcServerInterface;
...
static const MIDL_STUB_DESC ShadowDriverRPC_StubDesc = 
    {
    (void *)& ShadowDriverRPC___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION ShadowDriverRPC_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE ShadowDriverRPC_v1_0_DispatchTable = 
    {
    3,
    (RPC_DISPATCH_FUNCTION*)ShadowDriverRPC_table
    };

static const SERVER_ROUTINE ShadowDriverRPC_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RPCTest,
    (SERVER_ROUTINE)GetShadowDriverVersion,
    (SERVER_ROUTINE)Shutdown
    };

static const MIDL_SERVER_INFO ShadowDriverRPC_ServerInfo = 
    {
    &ShadowDriverRPC_StubDesc,
    ShadowDriverRPC_ServerRoutineTable,
    ShadowDriverRPC__MIDL_ProcFormatString.Format,
    ShadowDriverRPC_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
